...
function Navbar() {
    ...
    return (
        <div>
                ...
                <div className="px-3 py-5 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-gray-400 rounded-lg md:hidden hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600">
                            ...
                            <a href="https://flowbite.com" className="flex md:mr-24">
                                ...
                                <span className="self-center text-xl text-white font-semibold sm:text-2xl whitespace-nowrap">Commerce Max</span>
                            </a>
                        </div>
                            ...
                            <div className="flex items-center ml-3">
                                <div>
                                    <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                                        ...
                                        <img className="w-10 h-10 rounded-full" src={userInfo.currentUser.photoURL || "http://cdn.onlinewebfonts.com/svg/img_184513.png"} alt="user.photo" />
                                    </button>
                                </div>
                                <div className="z-50 hidden my-4 text-base list-none bg-bggray divide-y divide-gray-600 rounded shadow" id="dropdown-user">
                                    ...
                                    <ul className="py-1" role="none">
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white" role="menuitem">Mi Perfil</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white" role="menuitem">Mis Publicaciones</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white" role="menuitem">Configuración</a>
                                        </li>
                                        <li>
                                            <a onClick={logOut} href="#" className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white" role="menuitem">Log Out</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div>
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-24 transition-transform -translate-x-full bg-bggray border-r border-gray-500 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
                <div className="h-full px-3 pb-4 overflow-y-auto bg-bggray">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <a onClick={logOut} href="#" className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-gray-700">
